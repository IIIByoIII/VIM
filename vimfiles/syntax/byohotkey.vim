...
syn keyword autohotkeyStatement
      \ Break Continue Exit ExitApp Goto OnExit Pause Return
...
syn case ignore
syn match   autohotkeyArray             display '\w\{-}\['me=e-1,he=e-1
syn match   autohotkeyCustomFunction    display '\w\{-}('me=e-1,he=e-1
syn match   autohotkeyCustomClass       display '\a\w\{-}\.\w'me=e-2,he=e-2
syn match   autohotkeyCustomClass2      display '\w\{-}\[\w\{-}\][\.\[]'me=e-1,he=e-1 contains=autohotkeyCustomMethod2
syn match   autohotkeyCustomMethod      display '\.\w\{-}\.'hs=s+1,me=e-1,he=e-1
syn match   autohotkeyCustomMethod2     display '\[\w\{-}\]' contained
syn match   autohotkeyCustomLabel       display '\s*\a\w\{-}::\@!'me=e-1,he=e-1
syn match   autohotkeyColonEqual        display ':='
syn match   autohotkeyEqual             display '=' contained
syn match   autohotkeyEqualAtrib        display '^\w\{-}\s\==' contains=autohotkeyEqual
syn keyword autohotkeyGuiSubCommand
      \ New Add Show Submit Cancel Hide NoHide Destroy Font Color Margin On Off
      \ Minimize MinimizeBox Maximize MaximizeBox LastFound AlwaysOnTop
      \ AutoSize Left Center Right SysMenu Disabled
syn keyword autohotkeyGuiControlType
      \ Text Edit UpDown Picture Button Checkbox Radio DropDownList ComboBox
      \ ListBox ListView TreeView Link Hotkey DateTime MonthCal Slider Progress
      \ GroupBox Tab StatusBar ActiveX
syn region  autohotkeyMultilineString   start='^\s\{-}(' end='^\s\{-})' display 
syn match   autohotkeySubroutineComma   display ',' contained
syn match   autohotkeySubroutine        display ',\s\{}\w\+' contained contains=autohotkeySubroutineComma
syn region  autohotkeyGoSubroutine      start='GoSub' end='$' display contains=autohotkeySubroutine

syn case match
syn match   autohotkeyGuiVariable       display '\sv\L\w\+'hs=s+2
syn match   autohotkeyGuiLabel          display '\sg\L\w\+'hs=s+2
...
hi autohotkeyArray                  guifg=#c08050
hi autohotkeyCustomFunction         guifg=#fbb829 gui=bold
hi autohotkeyCustomClass            guifg=#539448 gui=bold
hi def link autohotkeyCustomClass2        autohotkeyCustomClass
hi autohotkeyCustomMethod           guifg=#53b498 
hi def link autohotkeyCustomMethod2       autohotkeyCustomMethod
hi autohotkeyCustomLabel            guifg=#e64366 gui=bold
hi autohotkeyColonEqual             guifg=#48b3d7 gui=bold
hi autohotkeyEqual                  guifg=#48f789 gui=bold
hi def link autohotkeyEqualAtrib          Normal
hi autohotkeyGuiSubCommand          guifg=#7da278
hi autohotkeyGuiControlType         guifg=#7d78a2
hi def link autohotkeyMultilineString     String
hi def link autohotkeySubroutineComma     Normal
hi def link autohotkeySubroutine          autohotkeyCustomLabel
hi def link autohotkeyGoSubroutine        Keyword

hi autohotkeyGuiVariable            guifg=#6d98e2
hi def link autohotkeyGuiLabel            autohotkeyCustomLabel
...
let b:current_syntax = "byohotkey"
